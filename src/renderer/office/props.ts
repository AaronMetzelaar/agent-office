...
import { anchorsFor, cloakroom as CR, depts, door, gymRelaxZ, kindOf, loungeSeat, minWidth, office as OF, queueSpots, queueZ, shellOf, type Bounds, type DeptDef, type DeptId, type SlotKind, type Tier } from './layout'
